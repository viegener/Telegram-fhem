...
sub TelegramBot_evalParseMode($$) {
  ...
  if ( $parseMode == 1 ) {
    ...
    $parseMode = 0;
    if ( $msg =~ /^[Mm]arkdown[vV]1(.*)$/is ) {
      $msg = $1;
      $parseMode = "Markdown";
    } elsif ( $msg =~ /^[Mm]arkdown[vV]2(.*)$/is ) {
      $msg = $1;
      $parseMode = "MarkdownV2";
    } elsif ( $msg =~ /^[Mm]arkdown(.*)$/is ) {
      $msg = $1;
      $parseMode = "Markdown";
    } elsif ( $msg =~ /^HTML(.*)$/is ) {
      $msg = $1;
...
<ul>
  ...
  <ul>
    ...
    <code>message|msg|_msg|send [ @&lt;peer1&gt; ... @&lt;peerN&gt; ] [ (&lt;keyrow1&gt;) ... (&lt;keyrowN&gt;) ] &lt;text&gt;</code></a></a></a></a><br>
    ...
    <li><a id="TelegramBot-set-silentmsg"><a id="TelegramBot-set-silentDocument"><a id="TelegramBot-set-silentLocation"><a id="TelegramBot-set-silentVoice"><a id="TelegramBot-set-silentInline"><code>silentmsg, silentImage, silentDocument, silentLocation, silentVoice , silentInline ...</code></a></a></a></a></a><br>
    ...
    <code>cmdSend|cmdSendSilent [ @&lt;peer1&gt; ... @&lt;peerN&gt; ] &lt;fhem command&gt;</code></a></a>
    <br>Executes the given fhem command and then sends the result to the given peers or the default peer (cmdSendSilent does the same as silent message).<br>
    ...
    <li><a id="TelegramBot-set-queryInline"><code>queryInline [ @&lt;peer1&gt; ... @&lt;peerN&gt; ] (&lt;keyrow1&gt;) ... (&lt;keyrowN&gt;) &lt;text&gt;</code></a><br>
    Sends the given message to the recipient(s) with an inline keyboard allowing direct response <br>
    ...
    <li><a id="TelegramBot-set-queryEditInline"><code>queryEditInline &lt;msgid&gt; [ @&lt;peer&gt; ] (&lt;keyrow1&gt;) ... (&lt;keyrowN&gt;) &lt;text&gt;</code></a><br>
    Updates the original message specified with msgId with the given message to the recipient(s) with an inline keyboard allowing direct response <br>
    ...
    <li><a id="TelegramBot-set-queryAnswer"><code>queryAnswer &lt;queryid&gt; [ &lt;text&gt; ] </code></a><br>
    ...
    <li><a id="TelegramBot-set-sendImage"><a id="TelegramBot-set-image"><code>sendImage|image [ @&lt;peer1&gt; ... @&lt;peerN&gt;] &lt;file&gt; [&lt;caption&gt;]</code></a></a><br>
    Sends a photo to the given peer(s) or if ommitted to the default peer. 
    ...
    <li><a id="TelegramBot-set-sendVideo"><code>sendVideo [ @&lt;peer1&gt; ... @&lt;peerN&gt;] &lt;file&gt; [&lt;caption&gt;]</code></a><br>
    Sends a video (prefered mp4 format accordingt to Telegram) to the given peer(s) or if ommitted to the default peer. 
    File is specifying a filename and path to the video file to be send. Further description for sendImage also applies here.
    </li>
    
    <li><a id="TelegramBot-set-sendMedia"><a id="TelegramBot-set-sendDocument"><code>sendMedia|sendDocument [ @&lt;peer1&gt; ... @&lt;peerN&gt;] &lt;file&gt;</code></a></a><br>
    Sends a media file (video, audio, image or other file type) to the given peer(s) or if ommitted to the default peer. Handling for files and peers is as specified above.
    </li>
    
    <li><a id="TelegramBot-set-sendVoice"><code>sendVoice [ @&lt;peer1&gt; ... @&lt;peerN&gt;] &lt;file&gt;</code></a><br>
    ...
    <li><a id="TelegramBot-set-silentImage"><a id="TelegramBot-set-silentVideo"><code>silentImage|silentVideo ...</code></a></a><br>
    Sends the given image/video silently (with disabled_notifications) to the recipients. Syntax and parameters are the same as in the send... command.
    </li>
    

  <br>
    <li><a id="TelegramBot-set-sendLocation"><code>sendLocation [ @&lt;peer1&gt; ... @&lt;peerN&gt;] &lt;latitude&gt; &lt;longitude&gt;</code></a><br>
  ...
  <br>
    <li><a id="TelegramBot-set-replaceContacts"><code>replaceContacts &lt;text&gt;</code></a><br>
    Set the contacts newly from a string. Multiple contacts can be separated by a space. 
    Each contact needs to be specified as a triple of contact id, full name and user name as explained above. 
    </li>
    
    <li><a id="TelegramBot-set-reset"><code>reset</code></a><br>
    Reset the internal state of the telegram bot. This is normally not needed, but can be used to reset the used URL, 
  ...
  <br>
    <li><a id="TelegramBot-set-token"><code>token &lt;apitoken&gt;</code></a><br>
    Specify a new APItoken to be stored for this bot
    </li>
  ...
  <b>Get</b>
  <ul>
    <li><a id="TelegramBot-get-urlForFile"><code>urlForFile &lt;fileid&gt;</code></a><br>
    Get a URL for a file id that was returned in a message
    </li>
    <li><a id="TelegramBot-get-update"><code></a><br>
    Update </code><br>Execute a single update (instead of automatic polling) - manual polling
    </li>
    <li><a id="TelegramBot-get-peerId"><code>peerId &lt;peer&gt;</code></a><br>
    Ask for a peerId for a given peer, the peer can be specified in the same form as in a message without the initial '@'
    </li>
  </ul>
  ...
  <br><br>
  <ul>
    <li><a id="TelegramBot-attr-defaultPeer"><code>defaultPeer&lt;name&gt;</code></a> <br>
    Specify contact id, user name or full name of the default peer to be used for sending messages. 
    </li> 
    <li><a id="TelegramBot-attr-defaultPeerCopy"><code>defaultPeerCopy &lt;1 (default) or 0&gt;</code></a><br>
    ...
    <li><a id="TelegramBot-attr-parseModeSend"><code>parseModeSend &lt;0_None or 1_Markdown or 4 MarkdownV1 (legacy support) or 5 MarkdownV2 or 2_HTML or 3_Inmsg&gt;</code></a><br>
    Specify the parse_mode (allowing formatting of text messages) for sent text messages. 0_None is the default where no formatting is used and plain text is sent. The different formatting options for markdown or HTML are described here <a href="https://core.telegram.org/bots/api/#formatting-options">https://core.telegram.org/bots/api/#formatting-options</a>. The option 3_Inmsg allows to specify the correct parse_mode at the beginning of the message (e.g. "Markdown*bold text*..." or "MarkdownV2*bold text*..." or "HTML*bold text*..." as message).
    <br>
    Markdown is currently using still Markdown (V1) legacy as standard.
    </li> 
    
    <li><a id="TelegramBot-attr-webPagePreview"><code>webPagePreview &lt;1 or 0&gt;</code></a><br>
    Disable / Enable (Default = 1) web page preview on links in messages. See parameter https://core.telegram.org/bots/api/#sendmessage as described here: https://core.telegram.org/bots/api/#sendmessage
    </li> 
    
    
    
  <br>
    <li><a id="TelegramBot-attr-cmdKeyword"><code>cmdKeyword &lt;keyword&gt;</code></a><br>
    Specify a specific text that needs to be sent to make the rest of the message being executed as a command. 
    ...
    <li><a id="TelegramBot-attr-cmdSentCommands"><code>cmdSentCommands &lt;keyword&gt;</code></a><br>
    Specify a specific text that will trigger sending the last commands back to the sender<br>
  ...
  <br>
    <li><a id="TelegramBot-attr-cmdFavorites"><code>cmdFavorites &lt;keyword&gt;</code></a><br>
    Specify a specific text that will trigger sending the list of defined favorites or executes a given favorite by number (the favorites are defined in attribute <code>favorites</code>).
    <br>
    NOTE: It is advised to set cmdRestrictedPeer for restricting access to this feature!<br>
    ...
    <li><a id="TelegramBot-attr-favorites"><code>favorites &lt;list of commands&gt;</code></a><br>
    Specify a list of favorite commands for Fhem (without cmdKeyword). Multiple favorites  are separated by a single semicolon (;). A double semicolon can be used to specify multiple commands for a single favorite <br>
    <br>
    ...
    <li><a id="TelegramBot-attr-favorites2Col"><code>favorites2Col &lt;1 or 0&gt;</code><br>
    Show favorites in 2 columns keyboard (instead of 1 column  - default)
    </li> 
    
    <li><a id="TelegramBot-attr-favoritesInline"><code>favoritesInline &lt;1 or 0&gt;</code></a><br>
    When set to 1 it shows favorite dialog as inline keyboard and results will be also displayed inline (instead of as reply keyboards - default)
    </li> 

  <br>
    <li><a id="TelegramBot-attr-cmdRestrictedPeer"><code>cmdRestrictedPeer &lt;peer(s)&gt;</code></a><br>Restrict the execution of commands only to messages sent from the given peername or multiple peernames
    ...
    <li><a id="TelegramBot-attr-cmdRespondChat"><code>cmdRespondChat &lt;1 or 0&gt;</code></a><br>
    Results / Responses from Commands will be sent to a group chat (1 = default) if originating from this chat. Otherwise responses will be sent only to the person initiating the command (personal chat) if set to value 0. <br>
    Note: Group chats also need to be allowed as restricted Peer in cmdRestrictedPeer if this is set. 
    </li> 
    
    <li><a id="TelegramBot-attr-allowUnknownContacts"><code>allowUnknownContacts &lt;1 or 0&gt;</code></a><br>
    ...
    <li><a id="TelegramBot-attr-saveStateOnContactChange"><code>saveStateOnContactChange &lt;1 or 0&gt;</code></a><br>
    Allow statefile being written on every new contact found, ensures new contacts not being lost on any loss of statefile. Default is on (1).
    </li> 
    
    <li><a id="TelegramBot-attr-cmdReturnEmptyResult"><code>cmdReturnEmptyResult &lt;1 or 0&gt;</code></a><br>
    Return empty (success) message for commands (default). Otherwise return messages are only sent if a result text or error message is the result of the command execution.
    </li> 

    <li><a id="TelegramBot-attr-allowedCommands"><code>allowedCommands &lt;list of command&gt;</code></a><br>
    Restrict the commands that can be executed through favorites and cmdKeyword to the listed commands (separated by space). Similar to the corresponding restriction in FHEMWEB. The allowedCommands will be set on the corresponding instance of an allowed device with the name "allowed_&lt;TelegrambotDeviceName&gt; and not on the telegramBotDevice! This allowed device is created and modified automatically.<br>
    <b>ATTENTION: This is not a hardened secure blocking of command execution, there might be ways to break the restriction!</b>
    </li> 

    <li><a id="TelegramBot-attr-allowChannels"><code>allowChannels &lt;0 or 1&gt;</code></a><br>
    Support also messages coming from channels to the bot. This must be explicitely activated, since channels contain anonymous messages (without a defined sender of the message)
    </li> 

    <li><a id="TelegramBot-attr-cmdTriggerOnly"><code>cmdTriggerOnly &lt;0 or 1&gt;</code></a><br>
    Restrict the execution of commands only to trigger command. If this attr is set (value 1), then only the name of the trigger even has to be given (i.e. without the preceding statement trigger). 
    ...
    <li><a id="TelegramBot-attr-queryAnswerText"><code>queryAnswerText &lt;text&gt;</code></a><br>
  ...
  <br>
    <li><a id="TelegramBot-attr-pollingTimeout"><code>pollingTimeout &lt;number&gt;</code></a><br>
    Used to specify the timeout for long polling of updates. A value of 0 is switching off any long poll. 
      <br>
    ...
    <li><a id="TelegramBot-attr-pollingVerbose"><code>pollingVerbose &lt;0_None 1_Digest 2_Log&gt;</code></a><br>
    Used to limit the amount of logging for errors of the polling connection. These errors are happening regularly and usually are not consider critical, since the polling restarts automatically and pauses in case of excess errors. With the default setting "1_Digest" once a day the number of errors on the last day is logged (log level 3). With "2_Log" every error is logged with log level 2. With the setting "0_None" no errors are logged. In any case the count of errors during the last day and the last error is stored in the readings <code>PollingErrCount</code> and <code>PollingLastError</code> 
    </li> 
    
    <li><a id="TelegramBot-attr-disable"><code>disable &lt;0 or 1&gt;</code></a><br>
    Used to disable the polling if set to 1 (default is 0). 
    </li> 
    
  <br>
    <li><a id="TelegramBot-attr-cmdTimeout"><code>cmdTimeout &lt;number&gt;</code></a><br>
    Used to specify the timeout for sending commands. The default is a value of 30 seconds, which should be normally fine for most environments. In the case of slow or on-demand connections to the internet this parameter can be used to specify a longer time until a connection failure is considered.
    </li> 

  <br>
    <li><a id="TelegramBot-attr-maxFileSize"><code>maxFileSize &lt;number of bytes&gt;</code></a><br>
    Maximum file size in bytes for transfer of files (images). If not set the internal limit is specified as 10MB (10485760B).
    </li> 
    <li><a id="TelegramBot-attr-filenameUrlEscape"><code>filenameUrlEscape &lt;0 or 1&gt;</code></a><br>
    Specify if filenames can be specified using url escaping, so that special chanarcters as in URLs. This specifically allows to specify spaces in filenames as <code>%20</code>. Default is off (0).
    </li> 

    <li><a id="TelegramBot-attr-maxReturnSize"><code>maxReturnSize &lt;number of chars&gt;</code></a><br>
    Maximum size of command result returned as a text message including header (Default is unlimited). The internal shown on the device is limited to 1000 chars.
    </li> 
    
    <li><a id="TelegramBot-attr-maxRetries"><code>maxRetries &lt;0,1,2,3,4,5&gt;</code></a><br>
    Specify the number of retries for sending a message in case of a failure. The first retry is sent after 10sec, the second after 100, then after 1000s (~16min), then after 10000s (~2.5h), then after approximately a day. Setting the value to 0 (default) will result in no retries.
    </li> 
  ...
  <br>
    ...
    Text to be sent as warning for unauthorized command requests. Default is shown here and $peer will be replaced with the actual contact full name and id if added. $msg will be replaced with the sent message.
    </li> 

    <li><a id="TelegramBot-attr-deleteResponseMessage"><code>deleteResponseMessage &lt;0 or 1&gt;</code></a><br>
    Delete final message on Favorites Dialog or cmd confirmation instead of sending static response text(default is off).
    </li> 
    



    <li><a id="TelegramBot-attr-utf8Special"><code>utf8Special &lt;0 or 1&gt;</code></a><br>Specify if utf8 encodings will be resolved before sending to avoid issues with timeout on HTTP send (experimental ! / default is off).
    </li> 
